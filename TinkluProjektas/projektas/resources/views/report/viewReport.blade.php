            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">Ataskaitos peržiūrėjimo forma</div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ url("/getreport") }}">
                                {{ csrf_field() }}
                                ...
                                <div>
                                    <label for="surname" class="col-md-4 control-label">Pasirinkite norimą ataskaitą</label>

                                    <div class="col-md-6">
                                        <select id="reportchoice" name="reportchoice">
                                            <option>Prietaisų veikimo ataskaita</option>
                                            <option>Darbuotojų veiklos ataskaita</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-4">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fa fa-btn fa-user"></i> Grąžinti Ataskaitą
                                        </button>
                                    </div>
                                </div>
                            </form>
